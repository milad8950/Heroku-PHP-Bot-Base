...
$config = ['admin' => [555504606,**ADMIN**],'channel' => "$channel",'channel2' => "$channel2",'channel3' => "$channel3"]; //ادیت کنید
//=====
define('API_KEY',"5240608815:AAFtg3lfTzZny-M8JL2GwXhT1N6oGKSnLT8"); //توکن فقط ادیت بشه
